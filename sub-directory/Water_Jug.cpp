...
int cap1,cap2,init1,init2,fin1,fin2,**V,**E,min_sol=INT_MAX;
vector<int> action; // In C++ standard template library, a vector is just an array with no limit to its memory size
...
bool state(int jug_1,int jug_2) // Adjacency Matrix representation for Graph with Depth First Search node expansion
{
 ...
 V[jug_1][jug_2]=seq++;
 if(jug_1==fin1 && jug_2==fin2)
 {
  if(seq<min_sol) min_sol=seq-1;
  cout<<endl<<" ";
  ...
  if(jug_1<cap1) // 1
   if(V[cap1][jug_2]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][cap1*(cap2+1) + jug_2]=V[jug_1][jug_2];
    state(cap1,jug_2);
    E[jug_1*(cap2+1) + jug_2][cap1*(cap2+1) + jug_2]=0;
    V[cap1][jug_2]=0; seq--;
    action.pop_back();
   }
  ...
  if(jug_2<cap2) // 2
   if(V[jug_1][cap2]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][jug_1*(cap2+1) + cap2]=V[jug_1][jug_2];
    state(jug_1,cap2);
    E[jug_1*(cap2+1) + jug_2][jug_1*(cap2+1) + cap2]=0;
    V[jug_1][cap2]=0; seq--;
    action.pop_back();
   }
  ...
  if(jug_1>0) // 3
   if(V[0][jug_2]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][0*(cap2+1) + jug_2]=V[jug_1][jug_2];
    state(0,jug_2);
    E[jug_1*(cap2+1) + jug_2][0*(cap2+1) + jug_2]=0;
    V[0][jug_2]=0; seq--;
    action.pop_back();
   }
  ...
  if(jug_2>0) // 4
   if(V[jug_1][0]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][jug_1*(cap2+1) + 0]=V[jug_1][jug_2];
    state(jug_1,0);
    E[jug_1*(cap2+1) + jug_2][jug_1*(cap2+1) + 0]=0;
    V[jug_1][0]=0; seq--;
    action.pop_back();
   }
  ...
  if(jug_1+jug_2>=cap1 && jug_2>0) // 5
   if(V[cap1][jug_2-(cap1-jug_1)]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][cap1*(cap2+1) + (jug_2-(cap1-jug_1))]=V[jug_1][jug_2];
    state(cap1,jug_2-(cap1-jug_1));
    E[jug_1*(cap2+1) + jug_2][cap1*(cap2+1) + jug_2-(cap1-jug_1)]=0;
  ...
  if(jug_1+jug_2>=cap2 && jug_1>0) // 6
   if(V[jug_1-(cap2-jug_2)][cap2]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][(jug_2-(cap1-jug_1))*(cap2+1) + cap2]=V[jug_1][jug_2];
    state(jug_1-(cap2-jug_2),cap2);
    E[jug_1*(cap2+1) + jug_2][(jug_2-(cap1-jug_1))*(cap2+1) + cap2]=0;
  ...
  if(jug_1+jug_2<=cap1 && jug_2>0) // 7
   if(V[jug_1+jug_2][0]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][(jug_1+jug_2)*(cap2+1) + 0]=V[jug_1][jug_2];
    state(jug_1+jug_2,0);
    E[jug_1*(cap2+1) + jug_2][(jug_1+jug_2)*(cap2+1) + 0]=0;
  ...
  if(jug_1+jug_2<=cap2 && jug_1>0) // 8
   if(V[0][jug_1+jug_2]==0)
   {
    ...
    E[jug_1*(cap2+1) + jug_2][0*(cap2+1) + (jug_1+jug_2)]=V[jug_1][jug_2];
    state(0,jug_1+jug_2);
    E[jug_1*(cap2+1) + jug_2][0*(cap2+1) + (jug_1+jug_2)]=0;
...
int main()
{
 ...
 if(state(jug1,jug2))
  {cout<<endl<<"Hence solution exists !"<<endl; cout<<"Minimum number of steps (i.e least cost solution) is "<<min_sol-1<<endl;}
 else
