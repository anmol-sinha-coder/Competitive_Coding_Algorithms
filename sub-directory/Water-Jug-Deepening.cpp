...
int cap1,cap2,init1,init2,fin1,fin2,**V,**E,seq=1; unsigned int depth_limit=1,x=0;
vector<int> action;
...
int main()
{
 ...
 int jug1=init1,jug2=init2; bool flag=0;
 while(::seq=1 && ++depth_limit<=10000) //Standard recursion depth in both 'R' and Python is about 10^4
  if(state(jug1=init1,jug2=init2))
    {flag=1; break;}
